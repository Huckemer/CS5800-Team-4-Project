    ...
    <table class = "table">
      <thead>
        <tr class="d-flex">
          ...
          <th class="col-1">Pickup Time</th>
          <th class="col-2">Dropoff Point</th>
          <th class="col-1">Dropoff Time</th>
        ...
        { (rides.length > 0) ? rides.map( (ride, index) => {
           return (
            <tr class="d-flex" key={ index }>
              ...
              <td class="col-1">{ ride.pickupTime}</td>
              <td class="col-2">{ ride.dropoffPoint }</td>
              <td class="col-1">{ ride.dropoffTime }</td>
              <td class="col-1">{ ride.availableSeats }</td>
              <td class="col-1">{ ride.vanID }</td>
